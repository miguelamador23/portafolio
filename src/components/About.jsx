    ...
    <>
      <section>
        ...
        <div className="Experiencia">
          ...
          <div className="bg-gray-100 p-4 rounded-md block ml-[15%] mt-[1%]">
            <div className="flex flex-col text-left">
              <h1 className="mb-2">Asesor de televentas</h1>
          ...
          <div className="bg-gray-100 p-4 rounded-md block ml-[15%] mt-[1%]">
            <div className="flex flex-col text-left">
              <h1 className="mb-2">Asesor de Atencion al cliente</h1>
              <span className="flex items-center">
                <svg
                  width="10"
                  height="10"
